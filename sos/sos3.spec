# Keep distribution naming convention of AL2 despite packaging on CentOS 7 on Copr
%define dist .amzn2
...
%changelog
* Sat Dec 30 2023 Erovia <erovia@users.noreply.github.com> - 3.9.1-1.amzn2
- Adapt to Amazon Linux 2
- Update to last 3.x release
